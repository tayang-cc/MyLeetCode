...
//coordinates given by a 0-indexed integer array nums and will start moving once given 
//the command to move. The robots will move a unit distance each second. 
//
...
//of the number line, whereas 'R' means the robot will move towards the right side 
//or positive side of the number line. 
//
// If two robots collide, they will start moving in opposite directions. 
//
// Return the sum of distances between all the pairs of robots d seconds after 
//the command. Since the sum can be very large, return it modulo 10⁹ + 7. 
//
// Note: 
//
// 
...
//they will change direction and the next second the first one will be in 0, heading 
//left, and another will be in 2, heading right. 
// For example, if a robot is positioned in 0 going to the right and another is 
...
// 
//
// Related Topics 脑筋急转弯 数组 前缀和 排序 👍 73 👎 0
